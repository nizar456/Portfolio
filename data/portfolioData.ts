...
export const projects: Project[] = [
  {
    ...
    techStack: ['Java', 'Spring Boot', 'PostgreSQL', 'Angular', 'Docker', 'Jenkins'],
  ...
  },
  {
    ...
    techStack: ['Java', 'Spring Boot', 'Spring Security', 'MySQL', 'Angular', 'Bootstrap'],
    githubUrl: 'https://github.com/nizarfikhan',
  },
  {
    ...
    techStack: ['Java', 'Spring Boot', 'React', 'MongoDB', 'Docker', 'Jenkins'],
    githubUrl: 'https://github.com/nizarfikhan',
  },
   {
    title: 'DevOps Project',
    description: 'An end-to-end DevOps project focused on containerized applications, implementing a microservices architecture for NGINX, WordPress, MariaDB, and Redis with optimized Docker images.',
    image: 'https://picsum.photos/seed/devops-cloud/800/600',
    techStack: ['Docker', 'Docker Compose', 'NGINX', 'Alpine Linux', 'Bash'],
    githubUrl: 'https://github.com/nizarfikhan',
  }
];
